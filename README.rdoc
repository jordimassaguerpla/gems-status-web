...
Download the gems-status-web-os from SUSE Studio Gallery http://susestudio.com/a/61bKK8/gems-status-web-os and:
  ...
  - edit /srv/www/vhosts/gems-status-web/shared/config/application.yml to set up your mail credentials
  - set GITHUB_KEY and GITHUB_SECRET environment variables 
